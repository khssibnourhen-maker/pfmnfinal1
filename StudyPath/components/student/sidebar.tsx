...
const navigation = [
  ...
  { name: "CV Builder", href: "/student/cv-builder", icon: FileText },
  { name: "Planification", href: "/student/planning", icon: Calendar },
  { name: "Mentorat", href: "/student/mentoring", icon: Users },
  { name: "Experiences", href: "/student/experiences", icon: Rocket },
  { name: "AI Career Mirror", href: "/student/career-mirror", icon: Brain },
  { name: "AI Coach", href: "/student/ai-coach", icon: Brain },
        ...
        <div className={cn(
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-sidebar-foreground truncate">Sarah Benali</p>
              <p className="text-xs text-sidebar-foreground/60 truncate">Etudiante</p>
            </div>
          )}
          {!collapsed && (
